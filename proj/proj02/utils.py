...
def plot_group(selection, ESG_sorted):
    selected_group = ESG_sorted[ESG_sorted["Group"] == selection]
    width, height = selected_group["Capacity_MW"], selected_group["Total_Var_Cost_USDperMWH"]
...
def all_groups_with_demand(demand, ESG_sorted):
    width = ESG_sorted["Capacity_MW"]
    height = ESG_sorted["Total_Var_Cost_USDperMWH"]
    x_vals = find_x_pos(width)
    energy_colors_dict = {}
    count = 0
    ...
    ESG_sorted['Color'] = colors_mapped
...
def profit(sorted_table, price):
    capacity_subset = sum(sorted_table[sorted_table["Total_Var_Cost_USDperMWH"] < price]["Capacity_MW"])
    revenue = capacity_subset * price
    cost = 0
    for i in range(len(sorted_table[sorted_table["Total_Var_Cost_USDperMWH"] < price]["Total_Var_Cost_USDperMWH"])):
        cost += sorted_table[sorted_table["Total_Var_Cost_USDperMWH"] < price]["Total_Var_Cost_USDperMWH"][i]\
        * sorted_table[sorted_table["Total_Var_Cost_USDperMWH"] < price]["Capacity_MW"][i]
    return revenue - cost
...
def plot_ue_by_ethrace(miami, not_miami):
    ...
    plt.subplot(221)
    plt.plot(np.arange(1979, 1986), miami["whites"], linewidth=2, color="tab:red")
    plt.plot(np.arange(1979, 1986), not_miami["whites"], linewidth=2, color="tab:blue")
    ...
    plt.subplot(222)
    plt.plot(np.arange(1979, 1986), miami["blacks"], linewidth=2, color="tab:red")
    plt.plot(np.arange(1979, 1986), not_miami["blacks"], linewidth=2, color="tab:blue")
    plt.vlines(1980, 0, 0.2, color="grey", linestyle="--", linewidth=2)
    plt.ylim((0,0.2))
    plt.xticks(np.arange(1979, 1986))
    ...
    plt.subplot(223)
    plt.plot(np.arange(1979, 1986), miami["hispanics"], linewidth=2, color="tab:red")
    plt.plot(np.arange(1979, 1986), not_miami["hispanics"], linewidth=2, color="tab:blue")
    plt.vlines(1980, 0, 0.2, color="grey", linestyle="--", linewidth=2)
    plt.ylim((0,0.2))
    plt.xticks(np.arange(1979, 1986))
    ...
    plt.subplot(224)
    plt.plot(np.arange(1979, 1986), miami["cubans"], linewidth=2, color="tab:red")
    plt.vlines(1980, 0, 0.2, color="grey", linestyle="--", linewidth=2)
    plt.ylim((0,0.2))
    plt.xticks(np.arange(1979, 1986))
...
def plot_wage_diffs_by_ethrace(miami, not_miami):
    ...
    plt.plot(np.arange(1979, 1986), 
             miami["whites"] - not_miami["whites"], linewidth=2, color="tab:red")
    ...
    plt.subplot(222)
    plt.plot(np.arange(1979, 1986), 
             miami["blacks"] - not_miami["blacks"], linewidth=2, color="tab:red")
    plt.hlines(0, 1979, 1985, color="grey", linestyle="--", linewidth=2)
    plt.vlines(1980, -0.3, 0.3, color="grey", linestyle="--", linewidth=2)
    plt.ylim((-0.3,0.3))
    plt.xticks(np.arange(1979, 1986))
    ...
    plt.subplot(223)
    plt.plot(np.arange(1979, 1986), 
             miami["hispanics"] - not_miami["hispanics"], linewidth=2, color="tab:red")
    plt.hlines(0, 1979, 1985, color="grey", linestyle="--", linewidth=2)
    plt.vlines(1980, -0.3, 0.3, color="grey", linestyle="--", linewidth=2)
    plt.ylim((-0.3,0.3))
    plt.xticks(np.arange(1979, 1986))
...
def plot_ue_by_educ(miami, not_miami):
    ...
    plt.subplot(221)
    plt.plot(np.arange(1979, 1986), miami["BA"], linewidth=2, color="tab:red")
    plt.plot(np.arange(1979, 1986), not_miami["BA"], linewidth=2, color="tab:blue")
    ...
    plt.subplot(222)
    plt.plot(np.arange(1979, 1986), miami["HS"], linewidth=2, color="tab:red")
    plt.plot(np.arange(1979, 1986), not_miami["HS"], linewidth=2, color="tab:blue")
    plt.vlines(1980, 0.01, 0.2, color="grey", linestyle="--", linewidth=2)
    plt.ylim((0.01,0.2))
    plt.xticks(np.arange(1979, 1986))
    ...
    plt.subplot(223)
    plt.plot(np.arange(1979, 1986), miami["lessHS"], linewidth=2, color="tab:red")
    plt.plot(np.arange(1979, 1986), not_miami["lessHS"], linewidth=2, color="tab:blue")
    plt.vlines(1980, 0.01, 0.2, color="grey", linestyle="--", linewidth=2)
    plt.ylim((0.01,0.2))
    plt.xticks(np.arange(1979, 1986))
